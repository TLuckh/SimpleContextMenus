...
namespace ServerRegistrationManager
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            Application app = new Application(new ConsoleOutputService());
            app.Run(args);
        }
        ...
        private static void HandleEmbeddedReferences()
        {
            ...
            AppDomain.CurrentDomain.AssemblyResolve += (sender, args) =>
            {
                ...
                string resourceName = executableName + ".EmbeddedReferences." + assemblyName + ".dll";
                ...
                using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(resourceName))
                {
                    ...
                    if (stream == null)
                        throw new InvalidOperationException(
                            $"Unable to load embedded assembly '{assemblyName}' from '{resourceName}'");
