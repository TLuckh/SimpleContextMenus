...
namespace ServerRegistrationManager.Actions
{
    ...
    public static class ShowHelpAction
    {
        ...
        {
            string resourceName = string.Format("{0}.Actions.Help.txt", typeof(ShowHelpAction).Assembly.GetName().Name);
            ...
            outputService.WriteMessage(
                "    -os[32|64]: Optional. Forces 32 bit or 64 bit installation (Ignores Environment.Is64BitOperatingSystem).");
            outputService.WriteMessage("");
