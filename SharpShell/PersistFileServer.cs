...
namespace SharpShell
{
    ...
    public abstract class PersistFileServer : SharpShellServer, IPersistFile
    {
        ...
        /// </summary>
        /// <param name="pClassID">
        ///     When this method returns, contains a reference to the CLSID. This parameter is passed
        ///     uninitialized.
        /// </param>
        ...
        ///     A zero-terminated string containing the absolute path of the file to which the object is
        ///     saved.
        /// </param>
        /// <param name="fRemember">
        ///     true to used the <paramref name="pszFileName" /> parameter as the current working file;
        ///     otherwise false.
        /// </param>
        ...
        /// <summary>
        ///     Retrieves either the absolute path to the current working file of the object or, if there is no current working
        ///     file, the default file name prompt of the object.
        /// </summary>
        /// <param name="ppszFileName">
        ///     When this method returns, contains the address of a pointer to a zero-terminated string
        ///     containing the path for the current file, or the default file name prompt (such as *.txt). This parameter is passed
        ///     uninitialized.
        /// </param>
