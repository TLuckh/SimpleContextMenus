...
#pragma warning disable 168
            IntPtr handle = previewHandlerHost.Handle;
#pragma warning restore 168
        ...
        private void UpdateHost()
        {
            ...
            OnPreviewHostThread(() =>
            {
                ...
                previewHandlerHost.Bounds = new Rectangle(previewArea.left, previewArea.top, previewArea.Width(),
                    previewArea.Height());
                ...
                if (previewHandlerControl != null)
                {
                    ...
                    previewHandlerControl.Bounds = new Rectangle(previewArea.left, previewArea.top, previewArea.Width(),
                        previewArea.Height());
            ...
            OnPreviewHostThread(() =>
                {
                    ...
                    previewHandlerHost.Bounds = new Rectangle(previewArea.left, previewArea.top, previewArea.Width(),
                        previewArea.Height());
                    if (previewHandlerControl != null)
                        previewHandlerControl.Bounds = new Rectangle(previewArea.left, previewArea.top,
        ...
        */
        ...
        /// <param name="ppvSite">
        ///     Address of pointer variable that receives the interface pointer requested in riid. Upon
        ///     successful return, *ppvSite contains the requested interface pointer to the site last seen in SetSite. The specific
        ///     interface returned depends on the riid argument—in essence, the two arguments act identically to those in
        ///     QueryInterface. If the appropriate interface pointer is available, the object must call AddRef on that pointer
        ///     before returning successfully. If no site is available, or the requested interface is not supported, this method
        ///     must *ppvSite to NULL and return a failure code.
        /// </param>
        /// <returns>
        ...
        /// </summary>
        /// <param name="pUnkSite">
        ///     A pointer to the IUnknown interface pointer of the site managing this object. If NULL, the
        ...
        /// <summary>
        ///     Sets the parent window of the previewer window, as well as the area within the parent to be used for the previewer
        ///     window.
        /// </summary>
        ...
        /// </summary>
        /// <param name="phwnd">
        ///     When this method returns, contains a pointer to the HWND returned from calling the GetFocus
        ...
        int IPreviewHandler.QueryFocus(out IntPtr phwnd)
        {
            ...
            if (previewHandlerControl != null)
                OnPreviewHostThread(() =>
                {
                    Control focusedControl = previewHandlerControl.FindFocusedControl();
        ...
        /// <summary>
        ///     Directs the preview handler to handle a keystroke passed up from the message pump of the process in which the
        ///     preview handler is running.
        /// </summary>
        /// <param name="pmsg">A pointer to a window message.</param>
        /// <returns>
        ///     If the keystroke message can be processed by the preview handler, the handler will process it and return S_OK. If
        ///     the preview handler cannot process the keystroke message, it will offer it to the host using TranslateAccelerator.
        ///     If the host processes the message, this method will return S_OK. If the host does not process the message, this
        ///     method will return S_FALSE.
        /// </returns>
