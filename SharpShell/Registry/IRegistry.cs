...
namespace SharpShell.Registry
{
    ...
    {
        /// <summary>
        ///     Opens a new <see cref="IRegistryKey" /> that represents the requested key on the local machine with the
        ///     specified view.
        /// </summary>
        ...
        ///     The user does not have the permissions required to perform this
        ///     action.
        /// </exception>
