...
namespace SharpShell.Registry
{
    ...
    public interface IRegistryKey : IDisposable
    {
        ...
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> is closed (closed
        ...
        /// </exception>
        /// <exception cref="T:System.ObjectDisposedException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> being manipulated
        ///     is closed (closed keys cannot be accessed).
        /// </exception>
        ...
        /// </exception>
        /// <exception cref="T:System.Security.SecurityException">
        ///     The user does not have the permissions required to access the
        ///     registry key in the specified mode.
        /// </exception>
        /// <PermissionSet>
        ///     <IPermission
        ///         class="System.Security.Permissions.RegistryPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"
        ...
        ///     One of the enumeration values that specifies whether the key is opened for read or
        ///     read/write access.
        /// </param>
        /// <exception cref="T:System.ArgumentNullException">
        ///     <paramref name="name" /> is null
        ...
        ///     <paramref name="permissionCheck" /> contains an invalid value.
        /// </exception>
        /// <exception cref="T:System.ObjectDisposedException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> is closed (closed
        ///     keys cannot be accessed).
        ...
        /// </exception>
        /// <exception cref="T:System.Security.SecurityException">
        ///     <paramref name="rights" /> includes invalid registry rights values.-or-The user does not have the requested
        ///     permissions.
        /// </exception>
        IRegistryKey OpenSubKey(string name, RegistryKeyPermissionCheck permissionCheck, RegistryRights rights);

        /// <summary>
        ///     Retrieves the value associated with the specified name. Returns null if the name/value pair does not exist in
        ///     the registry.
        /// </summary>
        ...
        /// </exception>
        /// <exception cref="T:System.ObjectDisposedException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> that contains the
        ///     specified value is closed (closed keys cannot be accessed).
        /// </exception>
        /// <exception cref="T:System.IO.IOException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> that contains the specified
        ///     value has been marked for deletion.
        /// </exception>
        /// <exception cref="T:System.UnauthorizedAccessException">The user does not have the necessary registry rights.</exception>
        /// <PermissionSet>
        ///     <IPermission
        ...
        /// <summary>
        ///     Retrieves the value associated with the specified name. If the name is not found, returns the default value
        ///     that you provide.
        /// </summary>
        /// <returns>
        ///     The value associated with <paramref name="name" />, with any embedded environment variables left unexpanded,
        ///     or <paramref name="defaultValue" /> if <paramref name="name" /> is not found.
        /// </returns>
        /// <param name="name">The name of the value to retrieve. This string is not case-sensitive.</param>
        ...
        /// <summary>
        ///     Retrieves the value associated with the specified name and retrieval options. If the name is not found,
        ///     returns the default value that you provide.
        /// </summary>
        /// <returns>
        ///     The value associated with <paramref name="name" />, processed according to the specified
        ///     <paramref name="options" />, or <paramref name="defaultValue" /> if <paramref name="name" /> is not found.
        /// </returns>
        /// <param name="name">The name of the value to retrieve. This string is not case-sensitive.</param>
        /// <param name="defaultValue">The value to return if <paramref name="name" /> does not exist. </param>
        ...
        /// </exception>
        /// <exception cref="T:System.ArgumentException">
        ///     <paramref name="options" /> is not a valid <see cref="T:Microsoft.Win32.RegistryValueOptions" /> value; for
        ///     example, an invalid value is cast to <see cref="T:Microsoft.Win32.RegistryValueOptions" />.
        /// </exception>
        /// <exception cref="T:System.UnauthorizedAccessException">The user does not have the necessary registry rights.</exception>
        /// <PermissionSet>
        ///     <IPermission
        ...
        /// <returns>
        ///     The newly created subkey, or null if the operation failed. If a zero-length string is specified for
        ///     <paramref name="subkey" />, the current <see cref="T:Microsoft.Win32.RegistryKey" /> object is returned.
        /// </returns>
        ...
        /// </exception>
        /// <exception cref="T:System.Security.SecurityException">
        ///     The user does not have the permissions required to create or open
        ///     the registry key.
        /// </exception>
        /// <exception cref="T:System.ObjectDisposedException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> on which this
        ///     method is being invoked is closed (closed keys cannot be accessed).
        /// </exception>
        /// <exception cref="T:System.UnauthorizedAccessException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> cannot be
        ///     written to; for example, it was not opened as a writable key , or the user does not have the necessary access
        ///     rights.
        /// </exception>
        /// <exception cref="T:System.IO.IOException">
        ///     The nesting level exceeds 510.-or-A system error occurred, such as deletion
        ///     of the key, or an attempt to create a key in the <see cref="F:Microsoft.Win32.Registry.LocalMachine" /> root.
        /// </exception>
        /// <PermissionSet>
        ///     <IPermission
        ///         class="System.Security.Permissions.RegistryPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"
        ...
        /// <summary>
        ///     Creates a new subkey or opens an existing subkey for write access, using the specified permission check
        ///     option.
        /// </summary>
        /// <returns>
        ///     The newly created subkey, or null if the operation failed. If a zero-length string is specified for
        ...
        /// </exception>
        /// <exception cref="T:System.UnauthorizedAccessException">
        ///     The current <see cref="T:Microsoft.Win32.RegistryKey" /> cannot
        ///     be written to; for example, it was not opened as a writable key, or the user does not have the necessary access
        ///     rights.
        /// </exception>
        /// <exception cref="T:System.IO.IOException">
        ///     The nesting level exceeds 510.-or-A system error occurred, such as deletion
        ...
        /// </exception>
        /// <exception cref="T:System.UnauthorizedAccessException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> is read-only,
        ///     and cannot be written to; for example, the key has not been opened with write access. -or-The
        ///     <see cref="T:Microsoft.Win32.RegistryKey" /> object represents a root-level node, and the operating system is
        ///     Windows Millennium Edition or Windows 98.
        /// </exception>
        /// <exception cref="T:System.Security.SecurityException">
        ///     The user does not have the permissions required to create or
        ///     modify registry keys.
        /// </exception>
        /// <exception cref="T:System.IO.IOException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> object represents a
        ///     root-level node, and the operating system is Windows 2000, Windows XP, or Windows Server 2003.
        /// </exception>
        /// <PermissionSet>
        ///     <IPermission
        ///         class="System.Security.Permissions.RegistryPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"
        ...
        /// </exception>
        /// <exception cref="T:System.ArgumentException">
        ///     The type of <paramref name="value" /> did not match the registry data type
        ///     specified by <paramref name="valueKind" />, therefore the data could not be converted properly.
        /// </exception>
        /// <exception cref="T:System.ObjectDisposedException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> that contains the
        ///     specified value is closed (closed keys cannot be accessed).
        ...
        /// </exception>
        /// <exception cref="T:System.ArgumentException">
        ///     Deletion of a root hive is attempted.-or-<paramref name="subkey" /> does
        ///     not specify a valid registry subkey.
        /// </exception>
        /// <exception cref="T:System.IO.IOException">An I/O error has occurred.</exception>
        /// <exception cref="T:System.Security.SecurityException">
        ///     The user does not have the permissions required to delete the
        ///     key.
        /// </exception>
        /// <exception cref="T:System.ObjectDisposedException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> being manipulated
        ...
        /// <summary>
        ///     Deletes the specified subkey and any child subkeys recursively, and specifies whether an exception is raised
        ///     if the subkey is not found.
        /// </summary>
        ...
        ///     Indicates whether an exception should be raised if the specified subkey cannot be
        ///     found. If this argument is true and the specified subkey does not exist, an exception is raised. If this argument
        ///     is false and the specified subkey does not exist, no action is taken.
        /// </param>
        /// <exception cref="T:System.ArgumentException">
        ///     An attempt was made to delete the root hive of the tree.-or-
        ///     <paramref name="subkey" /> does not specify a valid registry subkey, and <paramref name="throwOnMissingSubKey" />
        ///     is true.
        /// </exception>
        /// <exception cref="T:System.ArgumentNullException">
        ///     <paramref name="subkey" /> is null.
        ...
        /// </exception>
        /// <exception cref="T:System.UnauthorizedAccessException">
        ///     The <see cref="T:Microsoft.Win32.RegistryKey" /> being
        ///     manipulated is read-only.
        /// </exception>
        /// <PermissionSet>
        ///     <IPermission
        ///         class="System.Security.Permissions.RegistryPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"
        ...
        /// <summary>
        ///     Deletes the specified value from this key, and specifies whether an exception is raised if the value is not
        ///     found.
        /// </summary>
        /// <param name="name">The name of the value to delete. </param>
        /// <param name="throwOnMissingValue">
        ///     Indicates whether an exception should be raised if the specified value cannot be
        ///     found. If this argument is true and the specified value does not exist, an exception is raised. If this argument is
        ///     false and the specified value does not exist, no action is taken.
        /// </param>
        /// <exception cref="T:System.ArgumentException">
        ///     <paramref name="name" /> is not a valid reference to a value and <paramref name="throwOnMissingValue" /> is true.
        ///     -or- <paramref name="name" /> is null.
        /// </exception>
        /// <exception cref="T:System.Security.SecurityException">
        ///     The user does not have the permissions required to delete the
        ///     value.
        ...
        /// <exception cref="T:System.ArgumentException">
        ///     The <paramref name="subkey" /> parameter does not specify a valid registry
        ///     key
        /// </exception>
        /// <exception cref="T:System.ArgumentNullException">
        ///     <paramref name="subkey" /> is null
        ...
        /// </exception>
        /// <exception cref="T:System.ArgumentException">
        ///     <paramref name="subkey" /> does not specify a valid registry key, and <paramref name="throwOnMissingSubKey" /> is
        ///     true.
        /// </exception>
        /// <exception cref="T:System.ArgumentNullException">
        ///     <paramref name="subkey" /> is null.
