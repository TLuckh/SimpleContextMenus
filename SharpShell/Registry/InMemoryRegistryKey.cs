...
namespace SharpShell.Registry
{
    ...
    public class InMemoryRegistryKey : IRegistryKey
    {
        ...
        private readonly Dictionary<string, InMemoryRegistryKey> _subkeys =
            new Dictionary<string, InMemoryRegistryKey>();
        ...
        {
            InMemoryRegistryKey currentKey = this;
            string[] subkeyNames = name.Split(Separator);
        ...
        public object GetValue(string name, object defaultValue, RegistryValueOptions options)
        {
            ...
            string valueName = name ?? string.Empty;
            return _values.TryGetValue(valueName, out object value) ? value : defaultValue;
        }
        ...
        {
            InMemoryRegistryKey currentKey = this;
            string[] subkeyNames = subkey.Split(Separator);
            foreach (string subkeyName in subkeyNames)
            {
                string subkeyNameLower = subkeyName.ToLower();
                if (currentKey._subkeys.ContainsKey(subkeyNameLower) == false)
