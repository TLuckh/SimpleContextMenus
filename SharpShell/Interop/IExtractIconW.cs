...
namespace SharpShell.Interop
{
    ...
    public interface IExtractIconW
    {
        ...
        /// <returns></returns>
        [PreserveSig]
        int GetIconLocation(GILInFlags uFlags, [Out] [MarshalAs(UnmanagedType.LPWStr)] StringBuilder szIconFile,
            int cchMax, out int piIndex, out GILOutFlags pwFlags);
        ...
        /// </returns>
        [PreserveSig]
        int Extract([In] [MarshalAs(UnmanagedType.LPWStr)] string pszFile, uint nIconIndex, out IntPtr phiconLarge,
