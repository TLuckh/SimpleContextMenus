...
namespace SharpShell.Interop
{
    ...
    public interface IImageList
    {
        ...
        /// </summary>
        /// <param name="hbmImage">
        ///     A handle to the bitmap that contains the image or images. The number of images is inferred from
        ///     the width of the bitmap.
        /// </param>
        /// <param name="hbmMask">
        ///     A handle to the bitmap that contains the mask. If no mask is used with the image list, this
        ///     parameter is ignored.
        /// </param>
        /// <param name="pi">
        ///     When this method returns, contains a pointer to the index of the first new image. If the method fails
        ///     to successfully add the new image, this value is -1.
        /// </param>
        ...
        /// </summary>
        /// <param name="i">
        ///     A value of type int that contains the index of the image to replace. If i is -1, the function adds the
        ...
        /// <summary>
        ///     Adds a specified image to the list of images used as overlay masks. An image list can have up to four overlay masks
        ///     in Common Controls version 4.70 and earlier, and up to 15 in version 4.71 or later. The method assigns an overlay
        ///     mask index to the specified image.
        /// </summary>
        /// <param name="iImage">
        ///     A value of type int that contains the zero-based index of an image in the image list. This index
        ...
        /// </summary>
        /// <param name="hbmImage">
        ///     A handle to the bitmap that contains one or more images. The number of images is inferred from
        ///     the width of the bitmap.
        /// </param>
        /// <param name="crMask">
        ///     The color used to generate the mask. Each pixel of this color in the specified bitmap is changed
        ///     to black, and the corresponding bit in the mask is set to 1.
        /// </param>
        /// <param name="pi">
        ///     A pointer to an int that contains the index of the first new image when it returns, if successful, or
        ///     -1 otherwise.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="i">
        ///     A value of type int that contains the index of the image to remove. If this parameter is -1, the method
        ///     removes all images.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        ///     A pointer to an IMAGEINFO structure that receives information about the image. The information
        ///     in this structure can directly manipulate the bitmaps of the image.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="iDst">
        ///     A value of type int that contains the zero-based index of the destination image for the copy
        ///     operation.
        /// </param>
        ...
        /// <param name="dx">
        ///     A value of type int that contains the x-component of the offset of the second image relative to the
        ///     first image.
        /// </param>
        /// <param name="dy">
        ///     A value of type int that contains the y-component of the offset of the second image relative to the
        ///     first image.
        /// </param>
        ...
        /// </summary>
        /// <param name="cx">
        ///     A value of type int that contains the width, in pixels, of the images in the image list. All images in
        ///     an image list have the same dimensions.
        /// </param>
        /// <param name="cy">
        ///     A value of type int that contains the height, in pixels, of the images in the image list. All images
        ...
        /// <summary>
        ///     Sets the background color for an image list. This method only functions if you add an icon to the image list or use
        ///     the IImageList::AddMasked method to add a black and white bitmap. Without a mask, the entire image draws, and the
        ///     background color is not visible.
        /// </summary>
        /// <param name="clrBk">
        ///     The background color to set. If this parameter is set to CLR_NONE, then images draw transparently
        ///     using the mask.
        /// </param>
        /// <param name="pclr">
        ///     A pointer to a COLORREF that contains the previous background color on return if successful, or
        ///     CLR_NONE otherwise.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        ///     A value of type int that contains the x-component of the drag position relative to the
        ///     upper-left corner of the image.
        /// </param>
        /// <param name="dyHotspot">
        ///     A value of type int that contains the y-component of the drag position relative to the
        ///     upper-left corner of the image.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        /// <summary>
        ///     Locks updates to the specified window during a drag operation and displays the drag image at the specified position
        ///     within the window.
        /// </summary>
        /// <param name="hwndLock">A handle to the window that owns the drag image.</param>
        /// <param name="x">
        ///     The x-coordinate at which to display the drag image. The coordinate is relative to the upper-left
        ///     corner of the window, not the client area.
        /// </param>
        /// <param name="y">
        ///     The y-coordinate at which to display the drag image. The coordinate is relative to the upper-left
        ///     corner of the window, not the client area.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="x">
        ///     A value of type int that contains the x-coordinate where the drag image appears. The coordinate is
        ///     relative to the upper-left corner of the window, not the client area.
        /// </param>
        /// <param name="y">
        ///     A value of type int that contains the y-coordinate where the drag image appears. The coordinate is
        ///     relative to the upper-left corner of the window, not the client area.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="punk">
        ///     A pointer to the IUnknown interface that accesses the image list interface, which contains the new
        ///     image to combine with the drag image.
        /// </param>
        ...
        /// </summary>
        /// <param name="fShow">
        ///     A value that specifies whether to show or hide the image being dragged. Specify TRUE to show the
        ///     image or FALSE to hide the image.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        ///     A pointer to a POINT structure that receives the offset of the drag image relative to the drag
        ...
        /// <param name="dwFlags">
        ///     A pointer to a DWORD that contains the flags when the method returns. One of the following
        ///     values:
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        ...
        /// <param name="iOverlay">A value of type int that contains the one-based index of the overlay mask.</param>
        /// <param name="piIndex">
        ///     A pointer to an int that receives the zero-based index of an image in the image list. This index
        ///     identifies the image that is used as an overlay mask.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
