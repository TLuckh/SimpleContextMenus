namespace SharpShell.Interop
{
    ...
    public enum _SVSIF : uint
    {
        ...
        /// <summary>
        ///     In the case of a folder that cannot display all of its contents on one screen, display the portion that contains
        ///     the selected item.
        /// </summary>
        SVSI_ENSUREVISIBLE = 0x00000008,

        /// <summary>
        ///     Give the selected item the focus when multiple items are selected, placing the item first in any list of the
        ///     collection returned by a method.
        /// </summary>
        ...
        /// <summary>
        ///     Allows the window's default view to position the item. In most cases, this will place the item in the first
        ///     available position. However, if the call comes during the processing of a mouse-positioned context menu, the
        ///     position of the context menu is used to position the item.
        /// </summary>
        ...
        ///     You can indicate tri-check mode by specifying FWF_TRICHECKSELECT in IFolderView2::SetCurrentFolderFlags. The 3
        ///     states for FWF_TRICHECKSELECT are unchecked, SVSI_CHECK and SVSI_CHECK2.
        /// </summary>
