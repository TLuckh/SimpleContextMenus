...
namespace SharpShell.Interop
{
    ...
    public struct DESKBANDINFO
    {
        ...
        /// <summary>
        ///     The set of flags that determine which members of this structure are being requested by the caller. One or more of
        ...
        /// <summary>
        ///     A value that receives a set of flags that specify the mode of operation for the band object. One or more of the
        ///     following values:
        /// </summary>
        [Flags]
        public enum DBIMF : uint
        {
            ...
            /// <summary>
            ///     Windows XP and later: The band object is of a fixed sized and position. With this flag, a sizing grip is not
            ///     displayed on the band object.
            /// </summary>
            DBIMF_FIXED = 0x0001,

            /// <summary>
            ///     DBIMF_FIXEDBMP
            ///     Windows XP and later: The band object uses a fixed bitmap (.bmp) file as its background. Note that backgrounds are
            ///     not supported in all cases, so the bitmap may not be seen even when this flag is set.
            /// </summary>
            DBIMF_FIXEDBMP = 0x0004,

            /// <summary>
            ///     The height of the band object can be changed. The ptIntegral member defines the step value by which the band object
            ///     can be resized.
            /// </summary>
            ...
            ///     ptActual, a chevron is shown to indicate that there are more options available. These options are displayed when
            ...
            /// <summary>
            ///     Windows Vista and later: A sizing grip that allows the user to move or resize the band object is always shown, even
            ///     if that band object is the only one in the container.
            /// </summary>
