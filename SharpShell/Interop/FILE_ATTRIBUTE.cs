...
{
    /// <summary>
    ///     File attributes are metadata values stored by the file system on disk and are used by the system and are available
    ///     to developers via various file I/O APIs. For a list of related APIs and topics, see the See Also section.
    /// </summary>
    [Flags]
    public enum FILE_ATTRIBUTE
    {
        ...
        /// <summary>
        ///     The directory or user data stream is configured with integrity (only supported on ReFS volumes). It is not included
        ///     in an ordinary directory listing. The integrity setting persists with the file if it's renamed. If a file is copied
        ///     the destination file will have integrity set if either the source file or destination directory have integrity set.
        ...
        ///     In that scenario, the system can entirely avoid writing the data. Otherwise, the data is written after the handle
        ///     is closed.
        /// </summary>
