...
namespace SharpShell.Interop
{
    ...
    public interface ICatRegister
    {
        ...
        [PreserveSig]
        int RegisterClassImplCategories([In] ref Guid rclsid, uint cCategories,
        ...
        /// <param name="rgcatid">
        ///     The array of cCategories CATID that are to be removed. Only the category IDs specified in this
        ///     array are removed.
        /// </param>
        [PreserveSig]
        int UnRegisterClassImplCategories([In] ref Guid rclsid, uint cCategories,
            [In] [MarshalAs(UnmanagedType.LPArray)] Guid[] rgcatid);
        ...
        [PreserveSig]
        int RegisterClassReqCategories([In] ref Guid rclsid, uint cCategories,
            [In] [MarshalAs(UnmanagedType.LPArray)] Guid[] rgcatid);
        ...
        /// </param>
        [PreserveSig]
        int UnRegisterClassReqCategories([In] ref Guid rclsid, uint cCategories,
            [In] [MarshalAs(UnmanagedType.LPArray)] Guid[] rgcatid);
    }
}