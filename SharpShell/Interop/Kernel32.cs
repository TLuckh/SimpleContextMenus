...
namespace SharpShell.Interop
{
    ...
    public static class Kernel32
    {
        ...
        /// </summary>
        /// <param name="hModule">
        ///     A handle to the module whose executable file contains the resources that are being enumerated. If
        ///     this parameter is NULL, the function enumerates the resource names in the module used to create the current
        ///     process.
        /// </param>
        /// <param name="type">
        ///     The type of resource for which the name is being enumerated. Alternately, rather than a pointer,
        ///     this parameter can be MAKEINTRESOURCE(ID), where ID is an integer value representing a predefined resource type.
        ...
        ///     parameter can be MAKEINTRESOURCE(ID), where ID is the integer identifier of the resource. For more information, see
        ...
        ///     receives resource types. The ENUMRESTYPEPROC type defines a pointer to this callback function. EnumResTypeProc is a
        ///     placeholder for the application-defined function name.
        /// </summary>
        /// <param name="hModule">
        ///     A handle to the module whose executable file contains the resources for which the types are to be
        ///     enumerated. If this parameter is NULL, the function enumerates the resource types in the module used to create the
        ///     current process.
        /// </param>
        /// <param name="lpszType">
        ///     The type of resource for which the type is being enumerated. Alternately, rather than a pointer,
        ///     this parameter can be MAKEINTRESOURCE(ID), where ID is the integer identifier of the given resource type. For
        ///     standard resource types, see Resource Types. For more information, see the Remarks section below.
        /// </param>
        /// <param name="lParam">
        ///     An application-defined parameter passed to the EnumResourceTypes or EnumResourceTypesEx function.
        ///     This parameter can be used in error checking.
        /// </param>
        /// <returns>Returns TRUE to continue enumeration or FALSE to stop enumeration.</returns>
        ...
        /// </summary>
        /// <param name="hModule">
        ///     A handle to a module to be searched. This handle must be obtained through LoadLibrary or
        ///     LoadLibraryEx.
        /// </param>
        /// <param name="lpEnumFunc">
        ///     A pointer to the callback function to be called for each enumerated resource type. For more
        ///     information, see the EnumResTypeProc function.
        /// </param>
        ...
        /// </param>
        /// <param name="type">
        ///     The type of the resource for which the name is being enumerated. Alternately, rather than a pointer,
        ///     this parameter can be MAKEINTRESOURCE(ID), where ID is an integer value representing a predefined resource type.
        ///     For a list of predefined resource types, see Resource Types. For more information, see
        /// </param>
        /// <param name="lpEnumFunc">
        ///     A pointer to the callback function to be called for each enumerated resource name or ID. For
        ///     more information, see EnumResNameProc.
        /// </param>
        /// <param name="lParam">
        ...
        /// <returns></returns>
        [DllImport("kernel32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern bool EnumResourceNames(IntPtr hModule, IntPtr type, EnumResNameProc lpEnumFunc,
            IntPtr lParam);
        ...
        /// </summary>
        /// <param name="lpFileName">
        ///     Loads the specified module into the address space of the calling process. The specified module
        ...
        /// </param>
        /// <param name="lpType">
        ///     The resource type. Alternately, rather than a pointer, this parameter can be MAKEINTRESOURCE(ID),
        ///     where ID is the integer identifier of the given resource type. For standard resource types, see Resource Types.For
        ...
        /// </summary>
        /// <param name="hModule">
        ///     A handle to the module whose executable file contains the resource.If hModule is NULL, the system
        ///     loads the resource from the module that was used to create the current process.
        /// </param>
        /// <param name="hResInfo">
        ///     A handle to the resource to be loaded. This handle is returned by the FindResource or
        ///     FindResourceEx function.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is a handle to the data associated with the resource. If the
        ...
        /// </summary>
        /// <param name="hResData">
        ///     A handle to the resource to be accessed. The LoadResource function returns this handle. Note
        ///     that this parameter is listed as an HGLOBAL variable only for backward compatibility. Do not pass any value as a
        ///     parameter other than a successful return value from the LoadResource function.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="dwFlags">
        ///     The heap allocation options. Specifying any of these values will override the corresponding value
        ///     specified when the heap was created with HeapCreate.
        /// </param>
        /// <param name="dwBytes">
        ///     The number of bytes to be allocated.
        ///     If the heap specified by the hHeap parameter is a "non-growable" heap, dwBytes must be less than 0x7FFF8. You
        ...
        /// </param>
        /// <param name="dwFlags">
        ///     The heap free options. Specifying the following value overrides the corresponding value specified
        ///     in the flOptions parameter when the heap was created by using the HeapCreate function.
        /// </param>
        /// <param name="lpMem">
        ///     A pointer to the memory block to be freed. This pointer is returned by the HeapAlloc or HeapReAlloc
        ///     function. If this pointer is NULL, the behavior is undefined.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is nonzero.
        ///     If the function fails, the return value is zero.An application can call GetLastError for extended error
        ///     information.
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
    ...
    public enum LoadLibraryFlags : uint
    {
        ...
        ///     data or resources in the DLL, use LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE or LOAD_LIBRARY_AS_IMAGE_RESOURCE or both.
        ...
        ///     DLL. This action applies only to the DLL being loaded and not to its dependencies. This value is recommended for
        ...
        ///     data file. Nothing is done to execute or prepare to execute the mapped file. Therefore, you cannot call functions
        ...
        ///     process. Other processes cannot open the DLL file for write access while it is in use. However, the DLL can still
        ...
        ///     searched is unspecified. Directories in the standard search path are not searched. This value cannot be combined
