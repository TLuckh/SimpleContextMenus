...
namespace SharpShell.Interop
{
    ...
    public interface IExtractIconA
    {
        ...
        /// <returns></returns>
        [PreserveSig]
        int GetIconLocation(GILInFlags uFlags, [Out] [MarshalAs(UnmanagedType.LPStr)] StringBuilder szIconFile,
        ...
        /// </returns>
        [PreserveSig]
        int Extract([In] [MarshalAs(UnmanagedType.LPStr)] string pszFile, uint nIconIndex, out IntPtr phiconLarge,
