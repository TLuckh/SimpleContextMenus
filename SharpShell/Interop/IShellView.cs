...
namespace SharpShell.Interop
{
    ...
    public interface IShellView : IOleWindow
    {
        ...
        /// <returns>
        ///     Returns S_OK if successful, or a COM-defined error value otherwise. If the view returns S_OK, it indicates
        ///     that the message was translated and should not be translated or dispatched by Windows Explorer.
        /// </returns>
        [PreserveSig]
        ...
        ///     The address of the IShellView interface of the view window being exited. Views can use this
        ///     parameter to communicate with a previous view of the same implementation. This interface can be used to optimize
        ///     browsing between like views. This pointer may be NULL.
        /// </param>
        /// <param name="pfs">The address of a FOLDERSETTINGS structure. The view should use this when creating its view.</param>
        /// <param name="psb">
        ///     The address of the current instance of the IShellBrowser interface. The view should call this
        ///     interface's AddRef method and keep the interface pointer to allow communication with the Windows Explorer window.
        /// </param>
        ...
        /// <param name="ppv">
        ///     The address that receives the interface pointer. If an error occurs, the pointer returned must be
        ///     NULL.
        /// </param>
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
