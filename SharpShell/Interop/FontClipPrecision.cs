namespace SharpShell.Interop
{
    ...
    public enum FontClipPrecision : byte
    {
        ...
        ///     If not used, device fonts always rotate counterclockwise, but the rotation of other fonts is dependent on the
        ...
        /// <summary>
        ///     Windows XP SP1: Turns off font association for the font. Note that this flag is not guaranteed to have any effect
        ///     on any platform after Windows Server 2003.
        /// </summary>
