...
namespace SharpShell.Interop
{
    ...
    public static class Shell32
    {
        ...
        ///     are not used and must be NULL. This event should also be sent for registered protocols.
        /// </summary>
        public static int SHCNE_ASSOCCHANGED = 0x08000000;
        ...
        /// <param name="iFile">
        ///     Index of the file to query. If the value of this parameter is 0xFFFFFFFF, DragQueryFile returns a
        ///     count of the files dropped. If the value of this parameter is between zero and the total number of files dropped,
        ...
        ///     This file name is a null-terminated string. If this parameter is NULL, DragQueryFile returns the required size, in
        ...
        public static extern uint DragQueryFile(IntPtr hDrop, uint iFile,
            [Out] [MarshalAs(UnmanagedType.LPTStr)] StringBuilder lpszFile, uint cch);

        /// <summary>
        ///     Performs an operation on a specified file.
        /// </summary>
        /// <param name="pExecInfo">
        ///     A pointer to a SHELLEXECUTEINFO structure that contains and receives information about the
        ...
        /// </summary>
        /// <param name="rfid">
        ///     A reference to the KNOWNFOLDERID that identifies the folder. The folders associated with the known
        ///     folder IDs might not exist on a particular system.
        /// </param>
        /// <param name="dwFlags">
        ///     Flags that specify special retrieval options. This value can be 0; otherwise, it is one or more
        ///     of the KNOWN_FOLDER_FLAG values.
        /// </param>
        /// <param name="hToken">
        ///     An access token used to represent a particular user. This parameter is usually set to NULL, in
        ///     which case the function tries to access the current user's instance of the folder.
        /// </param>
        /// <param name="ppidl">
        ///     When this method returns, contains a pointer to the PIDL of the folder. This parameter is passed
        ///     uninitialized. The caller is responsible for freeing the returned PIDL when it is no longer needed by calling
        ///     ILFree.
        /// </param>
        ...
        ///     is no longer needed by calling CoTaskMemFree. The returned path does not include a trailing backslash. For example,
        ...
        /// </summary>
        /// <param name="pcsfv">
        ///     Pointer to a SFV_CREATE structure that describes the particulars used in creating this instance of
        ///     the Shell folder view object.
        /// </param>
        /// <param name="ppsv">
        ///     When this function returns successfully, contains an interface pointer to the new IShellView object.
        ...
        /// </summary>
        /// <param name="pcsfv">
        ///     Pointer to a structure that describes the details used in creating this instance of the Shell
        ///     folder view object.
        /// </param>
        /// <param name="ppsv">
        ///     The address of an IShellView interface pointer that, when this function returns successfully, points
        ///     to the new view object. On failure, this value is NULL.
        /// </param>
        /// <returns>If this function succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [DllImport("shell32.dll")]
        ...
        /// </summary>
        /// <param name="ppshf">
        ///     When this method returns, receives an IShellFolder interface pointer for the desktop folder. The
        ///     calling application is responsible for eventually freeing the interface by calling its IUnknown::Release method.
        /// </param>
        /// <returns>If this function succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [DllImport("shell32.dll")]
        ...
        /// <param name="nFolder">
        ///     A CSIDL value that identifies the folder to be located. The folders associated with the CSIDLs
        ...
        /// <param name="ppidl">
        ///     The address of a pointer to an item identifier list structure that specifies the folder's location
        ///     relative to the root of the namespace (the desktop). The ppidl parameter is set to NULL on failure. The calling
        ///     application is responsible for freeing this resource by calling ILFree.
        /// </param>
        ...
        /// <param name="ppwsz">
        ///     A pointer to an allocated Unicode string that contains the result. SHStrDup allocates memory for
        ///     this string with CoTaskMemAlloc. You should free the string with CoTaskMemFree when it is no longer needed. In the
        ///     case of failure, this value is NULL.
        /// </param>
        ...
        /// <param name="riid">
        ///     Reference to the interface ID of the interface on which to base the object. This is typically the
        ///     IID of IContextMenu, IContextMenu2, or IContextMenu3.
        /// </param>
        ...
        /// <param name="ppv">
        ///     When this method returns, contains the interface pointer requested in riid. This is normally
        ///     IQueryAssociations.
        /// </param>
        /// <returns>If this function succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [DllImport("shell32.dll")]
        public static extern int AssocCreateForClasses(ASSOCIATIONELEMENT[] rgClasses, uint cClasses, Guid riid,
            out IntPtr ppv);
        ...
        /// <param name="pidl2">
        ///     A pointer to the second ITEMIDLIST structure. This structure is appended to the structure pointed
        ///     to by pidl1.
        /// </param>
        /// <returns>
        ///     Returns an ITEMIDLIST containing the combined structures. If you set either pidl1 or pidl2 to NULL, the
        ///     returned ITEMIDLIST structure is a clone of the non-NULL parameter. Returns NULL if pidl1 and pidl2 are both set to
        ///     NULL.
        /// </returns>
        [DllImport("shell32.dll")]
        ...
        /// </summary>
        /// <param name="pszPath">
        ///     A pointer to a null-terminated string of maximum length MAX_PATH that contains the path and file name. Both
        ...
        ///     structure that contains the list of item identifiers that uniquely identifies the file within the Shell's
        ///     namespace. The PIDL must be a fully qualified PIDL. Relative PIDLs are not allowed.
        ///     If the uFlags parameter includes the SHGFI_USEFILEATTRIBUTES flag, this parameter does not have to be a valid file
        ///     name. The function will proceed as if the file exists with the specified name and with the file attributes passed
        ///     in the dwFileAttributes parameter. This allows you to obtain information about a file type by passing just the
        ///     extension for pszPath and passing FILE_ATTRIBUTE_NORMAL in dwFileAttributes.
        ...
        ///     Winnt.h). If uFlags does not include the SHGFI_USEFILEATTRIBUTES flag, this parameter is ignored.
        /// </param>
        /// <param name="psfi">
        ...
        /// </param>
        /// <returns>
        ///     A combination of one or more file attribute flags (FILE_ATTRIBUTE_ values as defined in Winnt.h). If uFlags
        ///     does not include the SHGFI_USEFILEATTRIBUTES flag, this parameter is ignored.
        /// </returns>
        [DllImport("shell32.dll")]
        ...
        /// </returns>
        [DllImport("shell32.dll")]
        public static extern IntPtr SHGetFileInfo(IntPtr pszPath, uint dwFileAttribs, out SHFILEINFO psfi,
            uint cbFileInfo, SHGFI uFlags);
        ...
        /// <param name="ppv">
        ///     When this method returns, contains the interface pointer requested in riid. This is typically
        ///     IImageList.
        /// </param>
        /// <returns>If this function succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        ...
        /// <param name="ppidl">
        ///     A PIDL specifying the folder's location relative to the root of the namespace (the desktop). It is
        ///     the responsibility of the calling application to free the returned IDList by using CoTaskMemFree.
        /// </param>
        /// <returns>If this function succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [Obsolete(
        ...
        /// <param name="apidl">
        ///     An array of pointers to constant ITEMIDLIST structures, each of which uniquely identifies a file
        ///     object or subfolder relative to the parent folder. Each item identifier list must contain exactly one SHITEMID
        ///     structure followed by a terminating zero.
        /// </param>
        /// <param name="pdtInner">
        ///     A pointer to interface IDataObject. This parameter can be NULL. Specify pdtInner only if the
        ///     data object created needs to support additional FORMATETC clipboard formats beyond the default formats it is
        ///     assigned at creation. Alternatively, provide support for populating the created data object using non-default
        ///     clipboard formats by calling method IDataObject::SetData and specifying the format in the FORMATETC structure
        ///     passed in parameter pFormatetc.
        /// </param>
        ...
        /// </summary>
        /// <param name="wEventId">
        ///     Describes the event that has occurred. Typically, only one event is specified at a time. If more
        ///     than one event is specified, the values contained in the dwItem1 and dwItem2 parameters must be the same,
        ///     respectively, for all specified events. This parameter can be one or more of the following values:
        /// </param>
        /// <param name="uFlags">
        ///     Flags that, when combined bitwise with SHCNF_TYPE, indicate the meaning of the dwItem1 and dwItem2
        ///     parameters. The uFlags parameter must be one of the following values.
        /// </param>
