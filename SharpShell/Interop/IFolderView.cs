...
namespace SharpShell.Interop
{
    ...
    public interface IFolderView
    {
        ...
        /// <param name="pcItems">
        ///     Pointer to an integer that receives the number of items (files and folders) displayed in the
        ///     folder view.
        /// </param>
        ...
        /// </summary>
        /// <param name="ppt">
        ///     A pointer to an existing structure to be filled with the current sizing dimensions of the items in
        ///     the folder's view.
        /// </param>
        ...
        /// </summary>
        /// <param name="ppt">
        ///     Pointer to an existing structure to be filled with the default sizing dimensions of the items in the
        ///     folder's view.
        /// </param>
        ...
        /// <param name="apt">
        ///     A pointer to an array of cidl structures containing the locations each corresponding element in apidl
        ///     should be positioned.
        /// </param>
        /// <param name="dwFlags">One of the _SVSIF constants that specifies the type of selection to apply.</param>
        void SelectAndPositionItems(uint cidl, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] IntPtr[] apidl,
            ref POINT apt, uint dwFlags);
    }
}