...
namespace SharpShell.Interop
{
    ...
    {
        /// <summary>
        ///     Use default behavior, which respects the view option (the user setting to create new windows or to browse in
        ///     place). In most cases, calling applications should use this flag.
        /// </summary>
        ...
        /// <summary>
        ///     Specifies no folder tree for the new browse window. If the current browser does not match the SBSP_OPENMODE of the
        ///     browse object call, a new window is opened.
        /// </summary>
        SBSP_OPENMODE = 0x0010,

        /// <summary>
        ///     Specifies a folder tree for the new browse window. If the current browser does not match the SBSP_EXPLOREMODE of
        ///     the browse object call, a new window is opened.
        /// </summary>
        ...
        /// <summary>
        ///     Windows 7 and later. Do not add a new entry to the travel log. When the user enters a search term in the search box
        ///     and subsequently refines the query, the browser navigates forward but does not add an additional travel log entry.
        /// </summary>
        ...
        /// <summary>
        ///     Microsoft Internet Explorer 6 Service Pack 2 (SP2) and later. The navigation was possibly initiated by a webpage
        ///     with scripting code already present on the local system.
        /// </summary>
        ...
        /// <summary>
        ///     Microsoft Internet Explorer 6 Service Pack 2 (SP2) and later. The window is navigating to an untrusted, non-HTML
        ///     file. If the user attempts to download the file, do not allow the download.
        /// </summary>
        ...
        /// <summary>
        ///     Windows Internet Explorer 7 and later. If allowed by current registry settings, give the browser a destination to
        ///     navigate to.
        /// </summary>
