...
namespace SharpShell.Interop
{
    ...
    public interface IContextMenu
    {
        ...
        ///     set to the offset of the largest command identifier that was assigned, plus one. For example, if idCmdFirst is set
        ///     to 5 and you add three items to the menu with command identifiers of 5, 7, and 8, the return value should be
