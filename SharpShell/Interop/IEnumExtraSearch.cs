...
namespace SharpShell.Interop
{
    ...
    public interface IEnumExtraSearch
    {
        ...
        /// </summary>
        /// <param name="celt">
        ///     The number of search objects to be enumerated, starting from the current object. If celt is too
        ///     large, the method should stop and return the actual number of search objects in pceltFetched.
        /// </param>
        /// <param name="rgelt">
        ///     A pointer to an array of pceltFetched EXTRASEARCH structures containing information on the
        ///     enumerated objects.
        /// </param>
