...
namespace SharpShell.Interop
{
    ...
    public interface IDeskBand : IDockingWindow
    {
        ...
        ///     FALSE if the docking window object should hide its window and return its border space by calling SetBorderSpaceDW
        ///     with zero values.
        /// </param>
        /// <returns>
        ...
        ///     In response to this method, the IDockingWindow implementation must call SetBorderSpaceDW, even if no border space
        ///     is required or a change is not necessary.
        /// </summary>
        ...
        ///     interface, requesting IID_IDockingWindowSite.
        ///     The docking window object then uses that interface to negotiate its border space. It is the docking window object's
        ///     responsibility to release this interface when it is no longer needed.
        /// </param>
        ...
        /// </summary>
        /// <param name="dwBandID">
        ///     The identifier of the band, assigned by the container. The band object can retain this value if
        ///     it is required.
        /// </param>
        /// <param name="dwViewMode">
        ///     The view mode of the band object. One of the following values: DBIF_VIEWMODE_NORMAL,
        ///     DBIF_VIEWMODE_VERTICAL, DBIF_VIEWMODE_FLOATING, DBIF_VIEWMODE_TRANSPARENT.
        /// </param>
