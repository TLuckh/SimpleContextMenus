...
{
    /// <summary>
    ///     Exposes methods that either create or merge a shortcut menu associated with a Shell object. Allows client objects
    ///     to handle messages associated with owner-drawn menu items and extends IContextMenu2 by accepting a return value
    ///     from that message handling.
    /// </summary>
    [ComImport]
    ...
    public interface IContextMenu3 : IContextMenu2
    {
        ...
        /// <param name="uFlags">
        ///     Optional flags that specify how the shortcut menu can be changed. This parameter can be set to a
        ///     combination of the following values. The remaining bits of the low-order word are reserved by the system. The
        ///     high-order word can be used for context-specific communications. The CMF_RESERVED value can be used to mask the
        ///     low-order word.
        /// </param>
        /// <returns>
        ///     If successful, returns an HRESULT value that has its severity value set to SEVERITY_SUCCESS and its code value set
        ///     to the offset of the largest command identifier that was assigned, plus one. For example, if idCmdFirst is set to 5
        ///     and you add three items to the menu with command identifiers of 5, 7, and 8, the return value should be
        ...
        /// </summary>
        /// <param name="pici">
        ///     A pointer to a CMINVOKECOMMANDINFO or CMINVOKECOMMANDINFOEX structure containing information about
        ///     the command. For further details, see the Remarks section.
        /// </param>
        /// <returns>
        ...
        /// <param name="reserved">
        ///     Reserved. Applications must specify NULL when calling this method and handlers must ignore this
        ...
        /// </summary>
        /// <param name="uMsg">
        ///     The message to be processed. In the case of some messages, such as WM_INITMENUPOPUP, WM_DRAWITEM,
        ///     WM_MENUCHAR, or WM_MEASUREITEM, the client object being called may provide owner-drawn menu items.
        /// </param>
        /// <param name="wParam">
        ///     Additional message information. The value of this parameter depends on the value of the uMsg
        ///     parameter.
        /// </param>
        /// <param name="lParam">
        ///     Additional message information. The value of this parameter depends on the value of the uMsg
        ...
        /// </param>
        /// <param name="plResult">
        ///     The address of an LRESULT value that the owner of the menu will return from the message. This
