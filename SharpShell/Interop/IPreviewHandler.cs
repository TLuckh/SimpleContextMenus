...
namespace SharpShell.Interop
{
    ...
    public interface IPreviewHandler
    {
        ...
        /// <returns>
        ///     If the keystroke message can be processed by the preview handler, the handler will process it and return S_OK.
        ///     If the preview handler cannot process the keystroke message, it will offer it to the host using
        ///     TranslateAccelerator. If the host processes the message, this method will return S_OK. If the host does not process
        ///     the message, this method will return S_FALSE.
        /// </returns>
        [PreserveSig]
