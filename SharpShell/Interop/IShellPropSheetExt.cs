...
namespace SharpShell.Interop
{
    ...
    internal interface IShellPropSheetExt
    {
        ...
        ///     A pointer to a function that the property sheet handler calls to add a page to the property
        ///     sheet. The function takes a property sheet handle returned by the CreatePropertySheetPage function and the lParam
        ...
        /// <returns>
        ///     If successful, returns a one-based index to specify the page that should be initially displayed. See Remarks
        ...
        /// <param name="uPageID">
        ///     Not used.
        ///     Microsoft Windows XP and earlier: A type EXPPS identifier of the page to replace. The values for this parameter for
        ///     Control Panels can be found in the Cplext.h header file.
        /// </param>
        /// <param name="lpfnReplacePage">
        ///     A pointer to a function that the property sheet handler calls to replace a page to the
        ///     property sheet. The function takes a property sheet handle returned by the CreatePropertySheetPage function and the
