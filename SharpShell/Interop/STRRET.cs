...
namespace SharpShell.Interop
{
    ...
    public struct STRRET
    {
        ...
        public static STRRET CreateUnicode(string str)
        {
            ...
            STRRET strret = new STRRET { uType = STRRETTYPE.STRRET_WSTR };
        ...
        public enum STRRETTYPE
        {
            ...
            /// <summary>
            ///     The uOffset member value indicates the number of bytes from the beginning of the item identifier list where the
            ///     string is located.
            /// </summary>
