...
namespace SharpShell.Interop
{
    ...
    public interface IInputObjectSite
    {
        ...
        ///     Indicates if the object has gained or lost the focus. If this value is nonzero, the object has
        ///     gained the focus. If this value is zero, the object has lost the focus.
        /// </param>
        /// <returns></returns>
        [PreserveSig]
        int OnFocusChangeIS(
