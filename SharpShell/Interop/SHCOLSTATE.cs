...
/// <summary>
///     A pointer to a value that contains flags that indicate the default column state. This parameter can include a
...
[Flags]
    public enum SHCOLSTATEF
    {
        ...
        /// <summary>
        ///     Recommends that the folder view extract column information asynchronously, on a background thread, because
        ///     extracting this information can be time consuming.
        /// </summary>
