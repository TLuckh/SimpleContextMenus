...
{
    /// <summary>
    ///     The output quality. The output quality defines how carefully GDI must attempt to match the logical-font attributes
    ///     to those of an actual physical font. It can be one of the following values.
    /// </summary>
    public enum FontQuality : byte
    {
        ...
        ///     is enabled, which means that more font sizes are available, but the quality may be lower. Bold, italic, underline,
