...
namespace SharpShell.Interop
{
    ...
    public interface IShellBrowser : IOleWindow
    {
        ...
        /// <summary>
        ///     Allows the container to insert its menu groups into the composite menu that is displayed when an extended namespace
        ///     is being viewed or used.
        /// </summary>
        /// <param name="hmenuShared">A handle to an empty menu.</param>
        /// <param name="lpMenuWidths">
        ///     The address of an OLEMENUGROUPWIDTHS array of six LONG values. The container fills in
        ///     elements 0, 2, and 4 to reflect the number of menu elements it provided in the File, View, and Window menu groups.
        /// </param>
        ...
        ///     A handle to the composite menu constructed by calls to IShellBrowser::InsertMenusSB and the
        ///     InsertMenu function.
        /// </param>
        ...
        /// </summary>
        /// <param name="hmenuShared">
        ///     A handle to the in-place composite menu that was constructed by calls to
        ...
        /// </summary>
        /// <param name="fEnable">
        ///     Specifies whether the modeless dialog boxes are to be enabled or disabled. If this parameter is
        ///     nonzero, modeless dialog boxes are enabled. If this parameter is zero, modeless dialog boxes are disabled.
        /// </param>
        /// <returns>Returns S_OK if successful, or a COM-defined error value otherwise.</returns>
        [PreserveSig]
        ...
        /// <param name="wID">
        ///     The command identifier value corresponding to the keystroke in the container-provided accelerator
        ///     table. Containers should use this value instead of translating again.
        /// </param>
        /// <returns>Returns S_OK if successful, or a COM-defined error value otherwise.</returns>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="pidl">
        ///     The address of an ITEMIDLIST (item identifier list) structure that specifies an object's location.
        ///     This value is dependent on the flag or flags set in the wFlags parameter.
        /// </param>
        ...
        /// <param name="uFlags">
        ///     Flags specifying where the toolbar buttons should go. This parameter can be one or more of the
        ///     following values.
        /// </param>
        /// <returns>Returns S_OK if successful, or a COM-defined error value otherwise.</returns>
        [PreserveSig]
