...
{
    /// <summary>
    ///     Requests the form of an item's display name to retrieve through IShellItem::GetDisplayName and
    ///     SHGetNameFromIDList.
    /// </summary>
    /// <remarks>
    ///     Different forms of an item's name can be retrieved through the item's properties, including those listed here. Note
    ///     that not all
    ...
    public enum SIGDN : uint
    {
        ...
        /// <summary>
        ///     Returns the item's file system path, if it has one. Only items that report SFGAO_FILESYSTEM have a file system
        ///     path. When an
        ///     item does not have a file system path, a call to IShellItem::GetDisplayName on that item will fail. In UI this name
        ///     is
        ...
        /// <summary>
        ///     Returns the path relative to the parent folder in a friendly format as displayed in an address bar. This name is
        ///     suitable for
        ///     display to the user.
        /// </summary>
        ...
        ///     will fail. This name is suitable for display to the user in some cases, but note that it might not be specified for
        ///     all items.
        /// </summary>
