...
{
    /// <summary>
    ///     Extends the capabilities of IShellFolder. Its methods provide a variety of information about the contents of a
    ///     Shell folder.
    /// </summary>
    [ComImport]
    ...
    public interface IShellFolder2 : IShellFolder
    {
        ...
        /// </returns>
        [PreserveSig]
        new int GetAttributesOf(uint cidl, IntPtr apidl,
            ref SFGAO rgfInOut);
        ...
        /// </returns>
        [PreserveSig]
        new int GetUIObjectOf(IntPtr hwndOwner, uint cidl,
            IntPtr apidl, [In] ref Guid riid,
            uint rgfReserved, out IntPtr ppv);
        ...
        /// <param name="pcsFlags">
        ///     A pointer to a value that contains flags that indicate the default column state. This parameter
        ///     can include a combination of the following flags.
        /// </param>
        /// <returns>Returns S_OK if successful, or a COM error value otherwise.</returns>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="pidl">
        ///     A PIDL of the item, relative to the parent folder. This method accepts only single-level PIDLs. The
        ///     structure must contain exactly one SHITEMID structure followed by a terminating zero. This value cannot be NULL.
        /// </param>
        /// <param name="pscid">A pointer to an SHCOLUMNID structure that identifies the column.</param>
        /// <param name="pv">
        ///     A pointer to a VARIANT with the requested information. The value is fully typed. The value returned
        ///     for properties from the property system must conform to the type specified in that property definition's typeInfo
        ///     as the legacyType attribute.
        /// </param>
        /// <returns>Returns S_OK if successful, or a COM error value otherwise.</returns>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="pidl">
        ///     PIDL of the item for which you are requesting information. This method accepts only single-level
        ///     PIDLs. The structure must contain exactly one SHITEMID structure followed by a terminating zero. If this parameter
        ///     is set to NULL, the title of the information field specified by iColumn is returned.
        /// </param>
        /// <param name="iColumn">
        ///     The zero-based index of the desired information field. It is identical to the column number of
        ///     the information as it is displayed in a Windows Explorer Details view.
        /// </param>
        /// <param name="psd">
        ///     The zero-based index of the desired information field. It is identical to the column number of the
        ///     information as it is displayed in a Windows Explorer Details view.
        /// </param>
        /// <returns>Returns S_OK if successful, or a COM error value otherwise.</returns>
        [PreserveSig]
