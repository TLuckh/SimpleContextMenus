...
{
    /// <summary>
    ///     Exposed by the common file dialog boxes to be used when they host a Shell browser. If supported, ICommDlgBrowser
    ///     exposes methods that allow a Shell view to handle several cases that require different behavior in a dialog box
    ///     than in a normal Shell view. You obtain an ICommDlgBrowser interface pointer by calling QueryInterface on the
