...
namespace SharpShell.Interop
{
    ...
    public interface IShellExtInit
    {
        ...
        ///     A pointer to an ITEMIDLIST structure that uniquely identifies a folder. For property sheet
        ///     extensions, this parameter is NULL. For shortcut menu extensions, it is the item identifier list for the folder
        ///     that contains the item whose shortcut menu is being displayed. For nondefault drag-and-drop menu extensions, this
        ///     parameter specifies the target folder.
        /// </param>
        /// <param name="pDataObj">
        ///     A pointer to an IDataObject interface object that can be used to retrieve the objects being
        ///     acted upon.
        /// </param>
