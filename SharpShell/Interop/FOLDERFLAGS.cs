...
namespace SharpShell.Interop
{
    ...
    public enum FOLDERFLAGS : uint
    {
        ...
        /// <summary>
        ///     Automatically arrange the elements in the view. This implies LVS_AUTOARRANGE if the list-view control is used to
        ///     implement the view.
        /// </summary>
        ...
        /// <summary>
        ///     Make the folder behave like the desktop. This value applies only to the desktop and is not used for typical Shell
        ///     folders. This flag implies FWF_NOCLIENTEDGE and FWF_NOSCROLL.
        /// </summary>
        ...
        /// <summary>
        ///     Windows Vista and later. Do not re-enumerate the view (or drop the current contents of the view) when the view is
        ///     refreshed.
        /// </summary>
        ...
        /// <summary>
        ///     Windows Vista and later. When the view is in "tile view mode" the layout of a single item should be extended to the
        ///     width of the view.
        /// </summary>
        ...
        /// <summary>
        ///     Windows Vista and later. The view should list the number of items displayed in each group. To be used with
        ...
        /// <summary>
        ///     Windows Vista and later. Ensure right-to-left reading layout in a right-to-left system. Without this flag, the view
        ///     displays strings from left-to-right both on systems set to left-to-right and right-to-left reading layout, which
        ///     ensures that file names display correctly.
        /// </summary>
