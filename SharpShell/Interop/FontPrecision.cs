namespace SharpShell.Interop
{
    ...
    ///     width, character orientation, escapement, pitch, and font type. It can be one of the following values.
    /// </summary>
    public enum FontPrecision : byte
    {
        ...
        /// <summary>
        ///     This value is not used by the font mapper, but it is returned when TrueType, other outline-based fonts, and vector
