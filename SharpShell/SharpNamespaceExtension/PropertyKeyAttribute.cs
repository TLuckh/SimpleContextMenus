...
namespace SharpShell.SharpNamespaceExtension
{
    ...
    public class PropertyKeyAttribute : Attribute
    {
        ...
        public PropertyKeyAttribute(uint a, ushort b, ushort c, byte d, byte e, byte f, byte g, byte h, byte i, byte j,
            byte k, uint propertyId)
        {
        ...
        {
            PropertyKeyAttribute attribute = @enum.GetType()
