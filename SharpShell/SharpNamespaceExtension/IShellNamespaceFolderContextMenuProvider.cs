...
namespace SharpShell.SharpNamespaceExtension
{
    ...
    public interface IShellNamespaceFolderContextMenuProvider
    {
        ...
        /// <param name="folderItemIdLists">
        ///     The folder item identifier lists. The user may
        ///     select more than one item before right clicking.
        /// </param>
        /// <returns>
        ///     A context menu for the item(s). This can be a custom type
