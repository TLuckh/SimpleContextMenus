...
namespace SharpShell.Configuration
{
    ...
    public static class SystemConfigurationProvider
    {
        ...
        static SystemConfigurationProvider()
        {
            ...
            systemConfiguration =
                new Lazy<SystemConfiguration>(LoadConfiguration, LazyThreadSafetyMode.PublicationOnly);
        }
        ...
        ///     The configuration.
        /// </value>
        public static SystemConfiguration Configuration => systemConfiguration.Value;
        ...
        private static SystemConfiguration LoadConfiguration()
        {
            ...
            using (RegistryKey localMachineBaseKey = RegistryKey.OpenBaseKey(RegistryHive.LocalMachine,
                       Environment.Is64BitOperatingSystem ? RegistryView.Registry64 : RegistryView.Registry32))
            {
                //  Open the SharpShell Key.
                using (RegistryKey sharpShellKey = localMachineBaseKey.OpenSubKey(SharpShellKey,
        ...
        public static void Save()
        {
            ...
            {
                //  Open the SharpShell Key.
                using (RegistryKey sharpShellKey = localMachineBaseKey.CreateSubKey(SharpShellKey,
                           RegistryKeyPermissionCheck.ReadWriteSubTree))
                {
                    ...
                    sharpShellKey.SetValue(LogPathValue, Configuration.LogPath ?? string.Empty,
